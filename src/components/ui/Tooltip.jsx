      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className={`absolute z-50 whitespace-nowrap px-2 py-1 text-xs font-medium text-white bg-card border border-[#262626] rounded-md shadow-xl ${positionClasses[position]}`}
          >
            {content}
          </motion.div>
        )}
